        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: '18px' }}>
          ...
          <div>
            ...
            <div style={{ fontSize: '13px', color: 'var(--text-muted)', marginTop: '3px', fontWeight: '500' }}>
              Visão consolidada de performance e indicadores em tempo real · {new Date().toLocaleDateString('pt-BR', { weekday: 'long', day: 'numeric', month: 'long', year: 'numeric' })}
            </div>
          </div>
        </div>
